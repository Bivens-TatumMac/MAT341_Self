...
function pseinv = give_Least_Squares_Data_1(N)
...
% pseudoinverse of MAT
pseinv = (transpose(MAT)*MAT)^(-1)*transpose(MAT);
plot(MAT, pseinv);


end

% c) Data in plot oscillates, but steadily increases overall.